    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-10">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500">Join E-Shop to start shopping</p>
        </div>
        ...
        {loading && <div className="text-center text-indigo-600 font-medium mb-4 animate-pulse">Creating account...</div>}
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-slate-900 text-white py-3 rounded-xl font-bold hover:bg-indigo-600 transition-all shadow-md hover:shadow-lg transform active:scale-[0.98]"
          >
            Register
          </button>
        </form>
